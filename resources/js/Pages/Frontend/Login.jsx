                ...
                <div className="sm:p-5">
                    ...
                    <div className="sm:p-10">
                        <p>
                            ...
                            affiliated with CISCE. To proceed, you need to fill
                            out a form for provisional affiliation and submit
                            scanned copies of certain documents to the Council.
                        </p>
                        <br />
                        <p>
                            If you are a first-time user and do not have a
                            password, you need to register with CISCE. A
                            password will be sent to your email and mobile
                            number, using which you need to login to the system
                            and enter the details as required and upload the
                            documents
                            <Link
                                href={route("register")}
                        ...
                        <p>
                            ...
                            system from this page. Enter the mobile number and
                            the password you used while registering and click
                            the Login button. This will take you to a page where
                            you can enter the preliminary information and upload
